...
class Article
{
     ...
     * @Assert\Length(min=5,max=255,minMessage="le titre de l'article est trop court")
     */
    private $title;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=20,minMessage="le contenu de l'article est trop court")
     */
    private $content;
    /**
    ...
    /**
     * pour savoir si user connecté aime un article
     *
     * @param User $user
     * @return boolean
     */
